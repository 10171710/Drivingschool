/**
 * RouteWise Student Sidebar & Topbar — shared component
 * Include after style.css in every student dashboard page.
...
(function () {
  ...
  var ICO = {
    ...
    calendarPlus: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="12" y1="14" x2="12" y2="18"/><line x1="10" y1="16" x2="14" y2="16"/></svg>',
  ...
  var NAV = [
    { section: 'Dashboard' },
    { label: 'Overview',       href: 'student-overview.html',  icon: 'home' },
    { label: 'License Progress', href: 'student-progress.html', icon: 'trending' },
    { label: 'Book Lesson',    href: 'student-book.html',      icon: 'calendarPlus' },
    { label: 'Skills',         href: 'student-skills.html',    icon: 'target' },
    { section: 'Learning' },
    { label: 'My Lessons',     href: 'student-lessons.html',   icon: 'list' },
    { label: 'Mock Test',      href: 'student-mocktest.html',  icon: 'fileText' },
    { label: 'Notes',          href: 'student-notes.html',     icon: 'message' },
    { section: 'Account' },
    { label: 'Payments',       href: 'student-payments.html',  icon: 'creditCard' },
    { label: 'Settings',       href: 'student-settings.html',  icon: 'gear' }
  ];
  ...
  function renderSidebar(el) {
    el.innerHTML =
      '<div class="dash-sidebar-brand">'
        ...
        + '<span class="text-[10px] text-white/40 font-mono uppercase tracking-wider">Student</span></div>'
      + '</div>'
      + '<nav class="dash-sidebar-nav">' + buildNavItems() + '</nav>'
      + '<div class="dash-sidebar-footer">'
        + '<a href="../../index.html"><span class="nav-ico">' + ICO.home + '</span>Back to site</a>'
        + '<a href="#" id="rw-student-logout"><span class="nav-ico">' + ICO.logout + '</span>Log out</a>'
      + '</div>';
  }
  ...
  function renderTopbar(el) {
    ...
    el.innerHTML =
      '<div class="min-w-0 flex-1">'
          ...
          + '<p class="text-[11px] text-ink/40 dark:text-paper/40">Student Dashboard</p>'
      + '</div>'
  ...
  function init() {
    ...
    /* ── logout ── */
    document.addEventListener('click', function (e) {
      if (e.target.closest('#rw-student-logout')) {
        e.preventDefault();
